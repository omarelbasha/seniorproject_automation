...
public static final Logger log = Logger.getLogger(insertnewrequest.class.getName());
...
public void setup(){
  ...
  public void gottosearchresult() {
	  ...
	  s=sv.MakeNewRequest("c");
	  s.search("Omar", "Anwar", "Elbasha", "Franjyi", 204);
  }
  @Test(priority = 3)
  public void gotocriminalrequest() {
	  sr=new searchresult(driver);
	  sr.newrequest("criminal",1);
